...
{
    public class FacturaCompletaPDF_Compra:IDocument
    {
        ...
        public void Compose(IDocumentContainer container)
        {
            container.Page(page =>
            {
                ...
                {
                    col.Item().Text($"Proveedor: {Proveedor}");
                    col.Item().Text($"Tipo de venta: {TipoCompra}");
                ...
                page.Footer().AlignCenter().Text("Lista de Compra Generada por Monitux-POS - Compruebe Documento Original.").FontSize(10);
            });
        }
