        ...
        public async Task Importar_Orden(Dictionary<string, double> Lista, string proveedor)
        {
            ...
            foreach (var item_C in Lista)
            {
                ...
                foreach (var item in productos)
                {
                    ...
                    miniatura_Producto.Origen = "Factura_Compra"; // Asignar el origen de la miniatura del producto
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (compra.Tipo == "Credito")
            {
                var cuenta = new Cuentas_Pagar
                {
                    ...
                    Otros_Cargos = compra.Otros_Cargos,
            ...
            else
            {
                var egreso = new Egreso
                {
                    ...
                    Fecha = compra.Fecha,
                    Total = Math.Round(total, 2),
                    Tipo_Egreso = compra.Forma_Pago,
                    Descripcion = $"Compra según Factura: {compra.Secuencial}"
                };
